...
#define MAX_SAMPLES 100 // Nombre maximum d'échantillons à stocker
/* USER CODE END PD */
...
////volatile float mechanicalAngle;
//float currentVelocity;
//volatile float previousVelocity = 0;
//float Ts = 0.0001;
//
////volatile float electricalAngleEstimatedCorrected;
//volatile int16_t STO_PLL_ElAngle;
//volatile int16_t STC_ElAngle;
/* USER CODE END PV */
...
//}
//
//void updateValueVelocity(float currentAngle)
//{
//	// Low-pass filter //
//	float A = 100;
...
//		sharedCounter ++;
//
//	/* Motor Control Both Direction */
//	if (sharedCounter < 10000)//sharedCounter < 10
//	{
//	    DesiredSpeed = 270;
//	    Durationms = 50;
//		MC_ProgramSpeedRampMotor1_F(DesiredSpeed, Durationms);
//	    (void)MC_StartMotor1();
//	}
//	if (sharedCounter < 15000)//15
//	{
//	    DesiredSpeed = ((300 *10)/60)*65536;
//	    pMCI[M1]->pSTC->SpeedRefUnitExt = DesiredSpeed ;
//	}
//	else if (sharedCounter < 20000)//20
//	{
//	    DesiredSpeed = ((400 *10)/60)*65536;
//	    pMCI[M1]->pSTC->SpeedRefUnitExt = DesiredSpeed ;
//	}
//	else if (sharedCounter < 25000)//25
//	{
//	    DesiredSpeed = ((500 *10)/60)*65536;
//	    pMCI[M1]->pSTC->SpeedRefUnitExt = DesiredSpeed ;
//	}
//	else if (sharedCounter < 26000)//27
//	{
////		(void)MC_StopMotor1();
//		DesiredSpeed = 0;
//	    pMCI[M1]->pSTC->SpeedRefUnitExt = DesiredSpeed ;
//	}
//	else if (sharedCounter < 35000)//35
//	{
////	    DesiredSpeed = -270;
////	    Durationms = 50;
////		MC_ProgramSpeedRampMotor1_F(DesiredSpeed, Durationms);
...
//	  if ((-180 < tempElAngle)&&(tempElAngle < 180))
 //	  {
 //		  int16_t int16ElAngle = (int16_t)(tempElAngle/180.0*32768.0);
 //		  pSTC[M1]-> SPD -> hElAngle = int16ElAngle;
 ////		  &STO_PLL_M1._Super.hElAngle = int16ElAngle;
 //	  }
 //	  else
 //	  {
 //		  int16_t int16ElAngle = 0;
 //		  pSTC[M1]-> SPD -> hElAngle = int16ElAngle;
 ////		  &STO_PLL_M1._Super.hElAngle = int16ElAngle;
 //
 //	  }
